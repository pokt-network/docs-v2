...
The **POKT Network protocol** first launched on Mainnet in July 2020 with our original protocol, called [Morse](the-morse-protocol/). A major protocol upgrade, [Shannon](the-shannon-upgrade/), is already live on public testnet and dates for Mainnet will be confirmed shortly.

***

### The Live Protocol, [Morse](the-morse-protocol/)
...
{% content-ref url="the-morse-protocol/" %}
[the-morse-protocol](the-morse-protocol/)
{% endcontent-ref %}
