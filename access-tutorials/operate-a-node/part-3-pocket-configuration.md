...
To maximize your rewards, you’ll want to relay to other chains. We’ll cover that in more detail later but here is a list of [other blockchains you could relay to](https://docs.pokt.network/supported-blockchains/).
...
### Set open file limits <a href="#set-open-file-limits" id="set-open-file-limits"></a>
